...
public class ManageHospitalEmployees extends javax.swing.JPanel {
    ...
    public void populateOrganizationEmpComboBox() {
        ...
        organizationEmpJComboBox.addItem("Select");
        for (Organization organization : organizationDirectory.getOrganizationList()) {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Manage Hospital");
    ...
    public boolean validateData() {
        if (organizationEmpJComboBox.getSelectedItem().equals("Select") || nameJTextField.getText().trim().equals("")) {
